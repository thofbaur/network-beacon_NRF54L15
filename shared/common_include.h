...
#define BATTERY_LEVEL_1_THRESHOLD_MV	2900
#define BATTERY_LEVEL_2_THRESHOLD_MV	2750
#define BATTERY_LEVEL_3_THRESHOLD_MV	2550
...
#define P_MAIN_FIREWORK_ACTIVE		(P_BASE_MAIN + 3)
